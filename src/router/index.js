...
export const asyncRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'host',
        component: () => import('@/views/project/HostList.vue'),
        name: 'HostList',
        meta: { title: '主机列表', icon: 'nested' }
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'updateAPI/:api_id',
        component: () => import('@/views/case/UpdateAPI.vue'),
        name: 'updateCaseAPI',
        hidden: true
